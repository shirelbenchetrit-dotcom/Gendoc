// Envoi convocations - Mme Benramdane - SVT - Dimanche 31/05/2026
// Template v3 (Meet) + BCC
// Usage : node scripts/send-convocations-benramdane-3105.mjs
...
const students = [
  { prenom: 'Alexandre', email: 'alexandreboronad1@gmail.com',  h1: '08:30', h2: '09:00', sujet: '' },
  { prenom: 'Nandi',     email: 'takamnandi268@gmail.com',      h1: '09:00', h2: '09:30', sujet: '' },
  { prenom: 'Elio',      email: 'Elvievaughan83@gmail.com',     h1: '09:30', h2: '10:00', sujet: '' },
  { prenom: 'Sylvain',   email: 'vallsyanis@gmail.com',         h1: '10:00', h2: '10:30', sujet: '' },
  { prenom: 'Sophie',    email: 'spilloud22@gmail.com',         h1: '10:30', h2: '11:00', sujet: '' },
  { prenom: 'Augustin',  email: 'gushou09@orange.fr',           h1: '11:00', h2: '11:30', sujet: '' },
  { prenom: 'Rihanna',   email: 'rihannaritz@gmail.com',        h1: '12:30', h2: '13:00', sujet: "Comment les mitochondries, structures sans lesquelles on ne peut vivre, entraînent-elles la mort de nos cellules ?" },
  { prenom: 'Célia',     email: 'celiaoizel22@icloud.com',      h1: '13:00', h2: '13:30', sujet: '' },
  { prenom: 'Sarah',     email: 'sarahguerch9@gmail.com',       h1: '14:30', h2: '15:00', sujet: '' },
  { prenom: 'Alexandra', email: 'r2008alexandra@gmail.com',     h1: '16:00', h2: '16:30', sujet: '' },
  { prenom: 'Asmae',     email: 'Asmae.boujenane@outlook.com',  h1: '16:30', h2: '17:00', sujet: '' },
  { prenom: 'Sara',      email: 'norahouas5@gmail.com',         h1: '17:00', h2: '17:30', sujet: '' },
  { prenom: 'Amine',     email: 'adj021108@gmail.com',          h1: '18:00', h2: '18:30', sujet: "Comment le sucre peut-il soigner le cancer ?" },
  { prenom: 'Khadija',   email: 'khadijaazzati@gmail.com',      h1: '18:30', h2: '19:00', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.prenom.padEnd(10)} ${s.email.padEnd(36)} ${s.h1}-${s.h2}  → `)
  try {
