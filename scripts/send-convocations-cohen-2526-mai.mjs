// Envoi convocations - Mme Vanessa Cohen - Maths - Lun 25/05 + Mar 26/05/2026
// Template v3 (Meet) + BCC + nom complet
// Bandeau pour Maëlle Gabaston (SVT 26/05 annulé)
// Usage : node scripts/send-convocations-cohen-2526-mai.mjs
...
const students = [
  // Lundi 25/05/2026
  { nom: 'Levy Samuel',       email: 'Samuellevy2008@gmail.com',    jour: 'Lundi', date: '25/05/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Eline Collinet',    email: 'eline.quoi@gmail.com',        jour: 'Lundi', date: '25/05/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'Schapira Azalee',   email: 'schapiraazalee@gmail.com',    jour: 'Lundi', date: '25/05/2026', h1: '19:30', h2: '20:00', sujet: '' },
  // Mardi 26/05/2026
  { nom: 'Thomas Eva',        email: 'evathomastricault@yahoo.com', jour: 'Mardi', date: '26/05/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Daguenet Elisa',    email: 'elisa.daguenet@free.fr',      jour: 'Mardi', date: '26/05/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'Joey Sarfati',      email: 'sarfatijoey@gmail.com',       jour: 'Mardi', date: '26/05/2026', h1: '19:30', h2: '20:00', sujet: '' },
  { nom: 'Gabaston Maëlle',   email: 'mama.gabaston@gmail.com',     jour: 'Mardi', date: '26/05/2026', h1: '20:00', h2: '20:30', sujet: '', noticeBanner: "<strong>Important : ton oral de SVT initialement prévu mardi 26/05 20:00 est annulé.</strong> Tu as uniquement cet oral de Mathématiques à passer ce jour-là (cf. détails ci-dessous)." },
]
...
async function sendOne(s) {
  ...
  const payload = {
    ...
    subject: `${isUpdate ? '[Mise à jour] ' : ''}Convocation oral blanc — ${COMMON.matiere} — ${s.jour} ${s.date}`,
...
for (const s of students) {
  ...
  try {
    ...
    if (r.ok) { console.log(`✓ envoyé${s.noticeBanner ? ' (avec bandeau)' : ''}`); results.push({ s, ok: true }) }
