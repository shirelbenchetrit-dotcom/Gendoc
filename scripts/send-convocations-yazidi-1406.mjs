// Envoi convocations - Mme Dounia Yazidi - PC - Dimanche 14/06/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-yazidi-1406.mjs
...
const students = [
  { nom: 'Houinou Sephora',   email: 'Shouinou@gmail.com',          h1: '09:00', h2: '09:30', sujet: "En quoi les aliments irradiés sont-ils une solution sûre pour protéger notre santé ?" },
  { nom: 'Braik Léa',         email: 'leabraik@gmail.com',          h1: '09:30', h2: '10:00', sujet: '' },
  { nom: 'Bouram Adam',       email: 'adambouram2000@gmail.com',    h1: '10:00', h2: '10:30', sujet: '' },
  { nom: 'Patrasca Roxana',   email: 'roxanapatrasca@gmail.com',    h1: '10:30', h2: '11:00', sujet: '' },
  { nom: 'Roux Lorena',       email: 'lorena.roux2008@gmail.com',   h1: '11:00', h2: '11:30', sujet: '' },
  { nom: 'Mestouri Jade',     email: 'mestourijade@gmail.com',      h1: '14:30', h2: '15:00', sujet: '' },
  { nom: 'Barry Hawa',        email: 'hawa.barry07@icloud.com',     h1: '15:00', h2: '15:30', sujet: '' },
  { nom: 'Hanel Victoria',    email: 'vhanel1201@gmail.com',        h1: '15:30', h2: '16:00', sujet: '' },
  { nom: 'Lemonnier Léna',    email: 'lenalemonnier@icloud.com',    h1: '16:00', h2: '16:30', sujet: '' },
  { nom: 'Léa Manégrier',     email: 'lea.manegrier@gmail.com',     h1: '16:30', h2: '17:00', sujet: "Comment la physique et la chimie permettent-elles de concevoir des fils de suture intelligents, capables de détecter une infection postopératoire ?" },
  { nom: 'Tiaïba Donia',      email: 'doniatiaiba@gmail.com',       h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Keylhia Hie',       email: 'keylhiahie@gmail.com',        h1: '19:00', h2: '19:30', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(22)} ${s.email.padEnd(38)} ${s.h1}-${s.h2}  → `)
  try {
