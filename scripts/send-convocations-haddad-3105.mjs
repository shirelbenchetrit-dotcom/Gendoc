// Envoi convocations - M. Elie Haddad - Physique-Chimie - Dimanche 31/05/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-haddad-3105.mjs
...
const COMMON = {
  ...
  jour: 'Dimanche',
  date: '31/05/2026',
  professeur: 'M. Elie Haddad',
  formulaireSujet: 'https://forms.gle/5pDtPWepFKDJBiNh9',
}

const students = [
  { nom: 'Sacha David',     email: 'sdavid2222008@gmail.com',   h1: '09:00', h2: '09:30', sujet: "Le Père Noël existe-t-il ?" },
  { nom: 'Aurelie Domane',  email: 'domaaure@gmail.com',         h1: '09:30', h2: '10:00', sujet: "Comment la forme et le mode d'administration d'un médicament influencent-ils son efficacité dans le corps ?" },
  { nom: 'Swann Chauveau',  email: 'chauveau.swann@gmail.com',   h1: '10:00', h2: '10:30', sujet: "Comment réduire l'impact environnemental de l'industrie pharmaceutique ? L'exemple de l'ibuprofène." },
  { nom: 'Lina Kadda',      email: 'linakadda05@gmail.com',      h1: '11:00', h2: '11:30', sujet: '' },
  { nom: 'Norah Tassin',    email: 'norah.tassin@gmail.com',     h1: '11:30', h2: '12:00', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(20)} ${s.email.padEnd(38)} ${s.h1}-${s.h2}  → `)
  try {
