// Envoi convocations - Mme Benramdane - SVT - Lundi 18/05 + Mardi 19/05/2026
// Template v2 + formulation neutre
// Usage : node scripts/send-convocations-benramdane-lun-mar.mjs
...
// Chaque élève a sa propre date / jour
const students = [
  // Lundi 18/05/2026
  { prenom: 'Evie',     email: 'eviebijon92@gmail.com',         jour: 'Lundi', date: '18/05/2026', h1: '18:00', h2: '18:30', sujet: "En quoi la rapidité de la prise en charge d'un AVC est-elle cruciale pour limiter les séquelles neurologiques ?" },
  { prenom: 'Solene',   email: 'solene.loussouarn@outlook.fr',  jour: 'Lundi', date: '18/05/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { prenom: 'Gaspard',  email: 'gasparddugarreau@gmail.com',    jour: 'Lundi', date: '18/05/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { prenom: 'Camille',  email: 'camille.dupuis64@gmail.com',    jour: 'Lundi', date: '18/05/2026', h1: '20:00', h2: '20:30', sujet: '' },
  { prenom: 'Sandrine', email: 'sandrineslaim@gmail.com',       jour: 'Lundi', date: '18/05/2026', h1: '20:30', h2: '21:00', sujet: "Comment le cerveau peut-il générer une douleur en l'absence de lésion physique détectable ?" },
  // Mardi 19/05/2026
  { prenom: 'Lina',     email: 'linamkt18@gmail.com',           jour: 'Mardi', date: '19/05/2026', h1: '18:00', h2: '18:30', sujet: '' },
]
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#ecfdf5;border-left:4px solid #10b981;border-radius:0 10px 10px 0;">
            <tr><td style="padding:20px 22px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="font-size:13px;">
                ...
                <tr><td style="color:#64748b;padding:5px 0;vertical-align:top;">Connexion</td><td style="color:#334155;padding:5px 0;font-style:italic;line-height:1.5;">Le lien de connexion te sera envoyé par email <strong>le jour de l'oral</strong>.</td></tr>
...
for (const s of students) {
  process.stdout.write(`  • ${s.prenom.padEnd(10)} ${s.email.padEnd(40)} ${s.jour} ${s.date} ${s.h1}-${s.h2}  → `)
  try {
