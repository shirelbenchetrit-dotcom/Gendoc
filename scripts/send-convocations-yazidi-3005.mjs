// Envoi convocations - Mme Dounia Yazidi - Physique-Chimie - Samedi 30/05/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-yazidi-3005.mjs
...
const students = [
  { nom: 'DE KERMOYSAN Alma',          email: 'alma.dekermoysan@hotmail.com', h1: '09:00', h2: '09:30', sujet: '' },
  { nom: 'Chouikha Meyssa',            email: 'meyssa.chouikha@icloud.com',   h1: '09:30', h2: '10:00', sujet: '' },
  { nom: 'Besse mathilde',             email: 'mathilde.besse@yahoo.com',     h1: '10:00', h2: '10:30', sujet: "Comment la physique et la chimie permettent-elles de transformer une réaction explosive en œuvre d'art dans le ciel ?" },
  { nom: 'CHKILIT Noriane',            email: 'chkilitn@gmail.com',           h1: '10:30', h2: '11:00', sujet: "Comment le pH du corps peut-il influencer l'efficacité d'un médicament ?" },
  { nom: 'LOCOH-DONOU Olivia',         email: 'olivialocoh@icloud.com',       h1: '11:00', h2: '11:30', sujet: '' },
  { nom: 'DEPRAETER--NAWROTEK Aymeric', email: 'aymericdn2912@gmail.com',     h1: '11:30', h2: '12:00', sujet: '' },
  { nom: 'Kania Chloé',                email: 'ckaniahloe@gmail.com',         h1: '12:00', h2: '12:30', sujet: '' },
  { nom: 'Perradin Jade',              email: 'jade.perradin@gmail.com',      h1: '12:30', h2: '13:00', sujet: '' },
  { nom: 'Raymon Alexandra',           email: 'r2008alexandra@gmail.com',     h1: '14:00', h2: '14:30', sujet: '' },
  { nom: 'Bachtoula Malake',           email: 'bmalake90@gmail.com',          h1: '14:30', h2: '15:00', sujet: '' },
  { nom: 'Abouzeid Rokaya',            email: 'Rokya9790@gmail.com',          h1: '15:00', h2: '15:30', sujet: "Comment la mécanique des fluides permet-elle de mesurer la vitesse d'un avion et d'expliquer les difficultés rencontrées lors du vol Air France 447 ?" },
  { nom: 'Camara Tallyah',             email: 'Camaratallyah7@gmail.com',     h1: '15:30', h2: '16:00', sujet: "Pourquoi les veines apparaissent-elles bleues alors que le sang est rouge ?" },
  { nom: 'Reboul Romy',                email: 'romy.reboul@icloud.com',       h1: '16:00', h2: '16:30', sujet: '' },
  { nom: 'Schaeffer Antigone',         email: 'antigoneschaeffer@riseup.net', h1: '16:30', h2: '17:00', sujet: "Le Schweppes peut-il vraiment soigner le paludisme ?" },
  { nom: 'Guerch Sarah',               email: 'sarahguerch9@gmail.com',       h1: '17:00', h2: '17:30', sujet: '' },
  { nom: 'Rafa Olivia',                email: 'Oliviarafa1@icloud.com',       h1: '17:30', h2: '18:00', sujet: "Comment la consommation excessive de sucre peut-elle perturber l'équilibre chimique et acido-basique du corps ?" },
  { nom: 'Benchial Annfel',            email: 'Bannfel@icloud.com',           h1: '18:00', h2: '18:30', sujet: "En quoi la chimie des textiles a-t-elle révolutionné le monde de la haute couture ?" },
  { nom: "M'barki Inès",               email: 'ghizlenehadri2@gmail.com',     h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'GAY Marius',                 email: 'yagsuiram@gmail.com',          h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'Karanda Allegrah',           email: 'karandaallegrah8@gmail.com',   h1: '19:30', h2: '20:00', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(32)} ${s.email.padEnd(38)} ${s.h1}-${s.h2}  → `)
  try {
