// Envoi convocations - M. Gabriel Boccara - Physique-Chimie - Dimanche 24/05/2026
// Template v2 + formulation neutre
// Usage : node scripts/send-convocations-boccara-2405.mjs
...
const COMMON = {
  ...
  jour: 'Dimanche',
  date: '24/05/2026',
  professeur: 'M. Gabriel Boccara',
  formulaireSujet: 'https://forms.gle/5pDtPWepFKDJBiNh9',
}

const students = [
  { prenom: 'Daria',      email: 'daria.guillemain@icloud.com',     h1: '14:30', h2: '15:00', sujet: '' },
  { prenom: 'Emmanuelle', email: 'emmanuellelameul@gmail.com',      h1: '15:00', h2: '15:30', sujet: '' },
  { prenom: 'Rasool',     email: 'rasoolarman442@gmail.com',        h1: '15:30', h2: '16:00', sujet: "Comment le sang présent dans le corps humain maintient son pH ?" },
  { prenom: 'Ness',       email: 'nessesther.benarroch@gmail.com',  h1: '16:00', h2: '16:30', sujet: "Est-ce que tout le monde peut chanter de manière harmonieuse ?" },
  { prenom: 'Diane',      email: 'dianeherve72@gmail.com',          h1: '16:30', h2: '17:00', sujet: "Quelle est la solution la plus pertinente pour alimenter une voiture électrique entre la batterie lithium-ion et la pile à combustible à hydrogène ?" },
  { prenom: 'Lilia',      email: 'khaloufililia@gmail.com',         h1: '17:00', h2: '17:30', sujet: "Comment la chimie des esters permet-elle de reproduire les arômes des fruits ou des plantes ?" },
  { prenom: 'Hannah',     email: 'manaresi.hannah@gmail.com',       h1: '17:30', h2: '18:00', sujet: '' },
  { prenom: 'Cailyne',    email: 'cailynekhoch@gmail.com',          h1: '18:00', h2: '18:30', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.prenom.padEnd(12)} ${s.email.padEnd(38)} ${s.h1}-${s.h2}  → `)
  try {
