// Envoi convocations - Mme Vanessa Cohen - Maths - Dimanche 14/06/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-cohen-1406.mjs
...
const students = [
  { nom: 'Eva Green',              email: 'Sgreen.belair@gmail.com',      h1: '09:00', h2: '09:30', sujet: '' },
  { nom: 'Lemonnier Léna',         email: 'lenalemonnier@icloud.com',     h1: '09:30', h2: '10:00', sujet: '' },
  { nom: 'Gilbert Ambre',          email: 'ambre.k.gilbert@gmail.com',    h1: '10:00', h2: '10:30', sujet: '' },
  { nom: 'RUPRECHT Clémence',      email: 'clemence.ruprecht@gmail.com',  h1: '12:30', h2: '13:00', sujet: '' },
  { nom: 'SEGGANE Zakaria',        email: 'segganezakaria14@gmail.com',   h1: '14:00', h2: '14:30', sujet: '' },
  { nom: 'Morel Lessard Mathilde', email: 'mathilde.morelles@icloud.com', h1: '14:30', h2: '15:00', sujet: "Notre sourire est-il mathématique ?" },
  { nom: 'Fathallah Jafar',        email: 'Jafar.fathallah@gmail.com',    h1: '15:00', h2: '15:30', sujet: "La suite de Fibonacci est-elle réellement présente dans la nature, ou est-ce une interprétation humaine ?" },
  { nom: 'Correa Lya',             email: 'lyda.correa@yahoo.com',        h1: '15:30', h2: '16:00', sujet: '' },
  { nom: 'Ettair Shamse',          email: 'shamselina.ettair@gmail.com',  h1: '16:00', h2: '16:30', sujet: '' },
  { nom: 'Magdaleon Yanis',        email: 'yanismagdaleon@gmail.com',     h1: '16:30', h2: '17:00', sujet: '' },
  { nom: 'Idarraben Samia',        email: 'samiaidarraben@gmail.com',     h1: '17:00', h2: '17:30', sujet: "Peut-on prédire et modéliser la propagation d'une rumeur avec les mathématiques ?" },
  { nom: 'Abdelali Esma',          email: 'esma.abdelali1@gmail.com',     h1: '17:30', h2: '18:00', sujet: '' },
  { nom: 'ARRUCHUNAN Livina',      email: 'livinaarruchunan@gmail.com',   h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Quelven Leane',          email: 'leanequelven08@gmail.com',     h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Léa Manégrier',          email: 'lea.manegrier@gmail.com',      h1: '19:00', h2: '19:30', sujet: "À partir de combien de victoires consécutives peut-on considérer qu'un boxeur est exceptionnel ?" },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(26)} ${s.email.padEnd(38)} ${s.h1}-${s.h2}  → `)
  try {
