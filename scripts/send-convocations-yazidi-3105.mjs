// Envoi convocations - Mme Dounia Yazidi - Physique-Chimie - Dimanche 31/05/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-yazidi-3105.mjs
...
const students = [
  { nom: 'Huet Anastasia',                email: 'ana.huet20@gmail.com',                h1: '09:00', h2: '09:30', sujet: '' },
  { nom: 'Mujdei Beatrice',               email: 'beatricemujdei@gmail.com',            h1: '09:30', h2: '10:00', sujet: "Dans quelle mesure la chimiluminescence du luminol est-elle un outil fiable pour la détection de traces de sang sur les scènes de crime ?" },
  { nom: 'Dutrion Friedrich Louane',      email: 'friedrich.louane@gmail.com',          h1: '10:00', h2: '10:30', sujet: "De quelle façon l'étude de la vitesse des flux sanguins par effet Doppler permet-elle de diagnostiquer de manière fiable une insuffisance valvulaire mitrale, et quelles sont les limites de cette technique ?" },
  { nom: 'Ben Mohamed Ghalia',            email: 'ghaliabenmohamed897@gmail.com',       h1: '10:30', h2: '11:00', sujet: '' },
  { nom: 'Haefelin Marie-Madeleine',      email: 'mariemadeleinehaefelin@gmail.com',    h1: '11:00', h2: '11:30', sujet: '' },
  { nom: 'Pilloud Sophie',                email: 'spilloud22@gmail.com',                h1: '11:30', h2: '12:00', sujet: "Stéréochimie moléculaire : quand soigner revient à risquer d'empoisonner, le cas de la Thalidomide." },
  { nom: 'Koffi Solène',                  email: 'ksolene89@gmail.com',                 h1: '12:30', h2: '13:00', sujet: '' },
  { nom: 'Bejtetyene Enjy',               email: 'enjad.2008@gmail.com',                h1: '14:00', h2: '14:30', sujet: "Comment la physique permet-elle de modéliser le fonctionnement d'une fibre nerveuse et les maladies qui y sont liées ?" },
  { nom: 'Muhammad Aliza Khan',           email: 'Alizaakhann.93@gmail.com',            h1: '14:30', h2: '15:00', sujet: "Dans quelles mesures les ondes lumineuses et sonores ont-elles été utilisées à des fins de torture, et que nous apprend la physique sur leurs effets ?" },
  { nom: 'Bouhattach Noheyla',            email: 'Noheyla.912@gmail.com',               h1: '15:00', h2: '15:30', sujet: "Le pH salivaire de chien peut-il influencer chimiquement la cicatrisation d'une plaie ?" },
  { nom: 'Benhicham Chehrazad Mahjouba',  email: 'chehrazad.benhicham@outlook.fr',      h1: '15:30', h2: '16:00', sujet: "Comment les UV et IR dégradent-ils les vaccins ?" },
  { nom: 'Boulegroune Naëlle',            email: 'naelle.boulegroune@gmail.com',        h1: '16:00', h2: '16:30', sujet: '' },
  { nom: 'Assibatu Yonas',                email: 'jahsay235@gmail.com',                 h1: '16:30', h2: '17:00', sujet: "Le cancer du sein est-il encore une fatalité à l'ère des biotechnologies et des thérapies ciblées ?" },
  { nom: 'Balme Gail Charlotte',          email: 'charlottebg78@gmail.com',             h1: '17:00', h2: '17:30', sujet: '' },
  { nom: 'Tran Sara',                     email: 'sara.tran947@gmail.com',              h1: '17:30', h2: '18:00', sujet: '' },
  { nom: 'Chasan lisa',                   email: 'lisa.xuemei@gmail.com',               h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Bendjabeur Kamelia',            email: 'kamelia.bendjabeur@gmail.com',        h1: '18:30', h2: '19:00', sujet: "Comment faire un gâteau à l'ananas sans ananas ?" },
  { nom: 'Makosso Christyvie Wise',       email: 'christyviewise08@icloud.com',         h1: '19:00', h2: '19:30', sujet: "Est-ce que le temps suffit à faire un bon vin ?" },
  { nom: 'Deraoui Sanna',                 email: 'deraouisanna2@gmail.com',             h1: '19:30', h2: '20:00', sujet: '' },
  { nom: 'Boujenane Asmae',               email: 'Asmae.boujenane@outlook.com',         h1: '20:00', h2: '20:30', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(34)} ${s.email.padEnd(40)} ${s.h1}-${s.h2}  → `)
  try {
