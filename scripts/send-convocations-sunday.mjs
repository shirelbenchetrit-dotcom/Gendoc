// Envoi en batch des convocations - Dimanche 17/05/2026 - Mme Benramdane - Template v2
// Usage : node scripts/send-convocations-sunday.mjs
...
// 8 élèves du dimanche 17/05/2026 (les "17/06" dans la sheet étaient des typos)
const students = [
  { prenom: 'Lema',     email: 'lemadjoanna@gmail.com',         h1: '09:00', h2: '09:30', sujet: "Pourquoi le **** est toxiques pour tout les mamifères ?" },
  { prenom: 'Louka',    email: 'loukamil06@gmail.com',          h1: '09:30', h2: '10:00', sujet: "Pourquoi un AVC peut-il supprimer le mouvement volontaire sans faire disparaître le réflexe myotatique ?" },
  { prenom: 'Louise',   email: 'louisetrarieux@icloud.com',     h1: '10:00', h2: '10:30', sujet: '' },
  { prenom: 'Margot',   email: 'margotjacob95@gmail.com',       h1: '10:30', h2: '11:00', sujet: "Comment le fonctionnement du corps du cheval permet-il de produire et de contrôler le mouvement du saut ?" },
  { prenom: 'Maïwenn',  email: 'maiwenn.sewindou4@gmail.com',   h1: '11:00', h2: '11:30', sujet: '' },
  { prenom: 'Laura',    email: 'laourapoghosyan17@gmail.com',   h1: '11:30', h2: '12:00', sujet: '' },
  { prenom: 'Willan',   email: 'slefsihane78@hotmail.com',      h1: '12:00', h2: '12:30', sujet: '' },
  { prenom: 'Castille', email: 'castille2008@gmail.com',        h1: '12:30', h2: '13:00', sujet: '' },
]
...
console.log(`→ Envoi de ${students.length} convocations (${COMMON.jour} ${COMMON.date}, ${COMMON.matiere})...\n`)
const results = []
