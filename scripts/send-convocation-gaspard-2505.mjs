// Envoi convocation solo - Gaspard du Garreau - SVT Benramdane - Lun 25/05/2026
// Avec bandeau "déplacé depuis Lun 18/05 à sa demande"
// Usage : node scripts/send-convocation-gaspard-2505.mjs
...
const s = {
  nom: 'Gaspard du Garreau',
  email: 'gasparddugarreau@gmail.com',
  h1: '19:30',
  h2: '20:00',
  sujet: '',
}
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#fef3c7;border-left:4px solid #d97706;border-radius:0 8px 8px 0;">
            <tr><td style="padding:14px 18px;">
              <p style="margin:0;color:#78350f;font-size:13px;line-height:1.55;">
                📌 <strong>Comme convenu, ton oral SVT a été déplacé à ta demande.</strong> Nouvelle date : <strong>lundi 25/05/2026 à 19:30</strong> (cf. détails ci-dessous). Merci de ne pas tenir compte de la convocation précédente.
              </p>
            </td></tr>
          </table>
        </td></tr>
