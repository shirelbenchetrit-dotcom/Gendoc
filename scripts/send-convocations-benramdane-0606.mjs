// Envoi convocations - Mme Benramdane - SVT - Samedi 06/06/2026
// Template v3 (Meet) + BCC + nom complet en salutation
// Usage : node scripts/send-convocations-benramdane-0606.mjs
...
// "nom" = nom complet tel qu'il apparaît dans la sheet (sera utilisé dans "Bonjour <nom>")
const students = [
  { nom: 'Jimenez Londono David',          email: 'davidlozadajmenezlondono@gmail.com', h1: '08:30', h2: '09:00', sujet: '' },
  { nom: 'Zirnheld Nathanaël',             email: 'nath.zim@outlook.fr',                h1: '09:00', h2: '09:30', sujet: '' },
  { nom: 'Shane ségard',                   email: 'shanebni@hotmail.com',               h1: '09:30', h2: '10:00', sujet: '' },
  { nom: 'Andre Madeline',                 email: 'themadelineandre@gmail.com',         h1: '10:00', h2: '10:30', sujet: '' },
  { nom: 'Nkengue nanke Nadine Patricia',  email: 'nkenguenanke@gmail.com',             h1: '10:30', h2: '11:00', sujet: '' },
  { nom: 'Diawara Camara Fama',            email: 'famadiawara86@gmail.com',            h1: '11:00', h2: '11:30', sujet: '' },
  { nom: 'Giraud Naelie',                  email: 'naeliegiraud@icloud.com',            h1: '11:30', h2: '12:00', sujet: '' },
  { nom: 'Nkoto Belinga Dhelia',           email: 'dheliatnath@gmail.com',              h1: '12:00', h2: '12:30', sujet: '' },
  { nom: 'MENIDIOH Logan',                 email: 'logmnd08@gmail.com',                 h1: '12:30', h2: '13:00', sujet: '' },
  { nom: 'Perromat Manon',                 email: 'manon.perromat@gmail.com',           h1: '13:00', h2: '13:30', sujet: '' },
  { nom: 'Belouar Amira',                  email: 'abelouar.17@gmail.com',              h1: '13:30', h2: '14:00', sujet: '' },
  { nom: 'Goloko Djeneba',                 email: 'godjenaba@gmail.com',                h1: '17:00', h2: '17:30', sujet: '' },
  { nom: 'Braik Léa',                      email: 'leabraik@gmail.com',                 h1: '17:30', h2: '18:00', sujet: '' },
  { nom: 'Dikich Ayoub',                   email: 'dikichayoub@gmail.com',              h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Justin Kéthleen',                email: 'kethleen.justin2@gmail.com',         h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Rasool Arman',                   email: 'rasoolarman442@gmail.com',           h1: '19:00', h2: '19:30', sujet: "Comment les plantes médicinales agissent-elles sur le corps ?" },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(32)} ${s.email.padEnd(42)} ${s.h1}-${s.h2}  → `)
  try {
