// Envoi solo - Diawara Camara Fama - SVT Benramdane - Dim 07/06/2026 09:30
// Avec bandeau "déplacé à sa demande depuis Sam 06/06"
// Usage : node scripts/send-convocation-diawara-fama-0706.mjs
...
const s = {
  nom: 'Diawara Camara Fama',
  email: 'famadiawara86@gmail.com',
  h1: '09:30',
  h2: '10:00',
  sujet: '',
}
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#fef3c7;border-left:4px solid #d97706;border-radius:0 8px 8px 0;">
            <tr><td style="padding:14px 18px;">
              <p style="margin:0;color:#78350f;font-size:13px;line-height:1.55;">
                📌 <strong>Comme convenu, ton oral SVT a été déplacé à ta demande.</strong> Nouvelle date : <strong>dimanche 07/06/2026 à 09:30</strong> (cf. détails ci-dessous). Merci de ne pas tenir compte de la convocation précédente pour le samedi 06/06.
              </p>
            </td></tr>
          </table>
        </td></tr>
