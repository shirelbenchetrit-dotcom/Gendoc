// Envoi convocations - Mme Dounia Yazidi - PC - Samedi 13/06/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-yazidi-1306.mjs
...
const students = [
  { nom: 'Guglielmi Lilou',           email: 'lilou.guglielmi@icloud.com',     h1: '09:00', h2: '09:30', sujet: '' },
  { nom: 'Chollet Mathilde',          email: 'mathilde.chollet@outlook.com',   h1: '09:30', h2: '10:00', sujet: '' },
  { nom: 'Eva Green',                 email: 'Sgreen.belair@gmail.com',        h1: '10:00', h2: '10:30', sujet: '' },
  { nom: 'Clapson Marie',             email: 'marie.clapson@gmail.com',        h1: '10:30', h2: '11:00', sujet: '' },
  { nom: 'Fringand Léa',              email: 'leafringand@gmail.com',          h1: '11:00', h2: '11:30', sujet: '' },
  { nom: 'Mercier Tristan',           email: 'Tristan.mercier13@gmail.com',    h1: '11:30', h2: '12:00', sujet: '' },
  { nom: 'Betito Shyrel',             email: 'Shyrel.betito1802@gmail.com',    h1: '12:00', h2: '12:30', sujet: '' },
  { nom: 'Kaddour léa',               email: 'lea.kaddour@icloud.com',         h1: '12:30', h2: '13:00', sujet: "Les implants cochléaires" },
  { nom: 'Correa Lya',                email: 'lyda.correa@yahoo.com',          h1: '14:00', h2: '14:30', sujet: '' },
  { nom: 'Tafech Yara',               email: 'tafechyara38@gmail.com',         h1: '14:30', h2: '15:00', sujet: '' },
  { nom: 'Maillet-Contoz Tiphaine',   email: 'tiphainemailletcontoz@gmail.com',h1: '15:00', h2: '15:30', sujet: '' },
  { nom: 'Morel Lessard Mathilde',    email: 'mathilde.morelles@icloud.com',   h1: '15:30', h2: '16:00', sujet: "Comment des forces mécaniques contrôlées permettent-elles de déplacer des dents sans les endommager ?" },
  { nom: 'Ettair Shamse',             email: 'shamselina.ettair@gmail.com',    h1: '16:00', h2: '16:30', sujet: '' },
  { nom: 'Desquins Emma',             email: 'desquins.emma@gmail.com',        h1: '16:30', h2: '17:00', sujet: '' },
  { nom: 'Perromat Manon',            email: 'manon.perromat@gmail.com',       h1: '17:00', h2: '17:30', sujet: '' },
  { nom: 'Aurelie Conan',             email: 'aurelie.conangr@gmail.com',      h1: '17:30', h2: '18:00', sujet: '' },
  { nom: 'Alcime Edna',               email: 'ednaalcime18@gmail.com',         h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Goloko Djeneba',            email: 'godjenaba@gmail.com',            h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'HENNEKINNE Sarah',          email: 'Sarahhennekinne@gmail.com',      h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'Magdaleon Yanis',           email: 'yanismagdaleon@gmail.com',       h1: '19:30', h2: '20:00', sujet: '' },
]
