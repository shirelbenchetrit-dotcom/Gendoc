// Envoi convocations - Mme Dounia Yazidi - Physique-Chimie - Samedi 16/05/2026
// Template v2 + formulation neutre "lien de connexion"
// Usage : node scripts/send-convocations-yazidi.mjs
...
const students = [
  { prenom: 'Tom',      email: 'tomhomehr@gmail.com',             h1: '09:00', h2: '09:30', sujet: '' },
  { prenom: 'Sofia',    email: 'boukersisofia08@yahoo.com',       h1: '09:30', h2: '10:00', sujet: '' },
  { prenom: 'Angelina', email: 'cachonangelina@gmail.com',        h1: '10:00', h2: '10:30', sujet: "Comment le pH sanguin évolue-t-il lors d'activités physiques ?" },
  { prenom: 'Camille',  email: 'cambp2008@gmail.com',             h1: '10:30', h2: '11:00', sujet: "Quelles pratiques à notre échelle seraient à même d'impacter nos batteries, et comment ?" },
  { prenom: 'Chloé',    email: 'chloelh26@gmail.com',             h1: '11:00', h2: '11:30', sujet: '' },
  { prenom: 'Elea',     email: 'eleamartin.pro@gmail.com',        h1: '14:30', h2: '15:00', sujet: '' },
  { prenom: 'Sarah',    email: 'sarah.fdui@gmail.com',            h1: '15:00', h2: '15:30', sujet: "Comment la physique peut-elle nous permettre d'effectuer un saut parfait en CSO ?" },
  { prenom: 'Juliette', email: 'Juliette.2g@gmail.com',           h1: '15:30', h2: '16:00', sujet: '' },
  { prenom: 'Marie',    email: 'marieraymondyammine@outlook.com', h1: '16:00', h2: '16:30', sujet: "Comment un stimulateur cardiaque est-il capable de remplacer le fonctionnement naturel" },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.prenom.padEnd(10)} ${s.email.padEnd(42)} ${s.h1}-${s.h2}  → `)
  try {
