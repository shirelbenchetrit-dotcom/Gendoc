// Envoi convocations - Mme Vanessa Cohen - Maths - Lun 01/06 + Mar 02/06/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-cohen-0102juin.mjs
...
const students = [
  // Lundi 01/06/2026
  { nom: 'Boujhchina Aya',  email: 'ayaboukhchina27@gmail.com',     jour: 'Lundi', date: '01/06/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Moulin Maxime',   email: 'maxime.moulin.ponte@gmail.com', jour: 'Lundi', date: '01/06/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'Ghastine Sael',   email: 'ghastine.sael@gmail.com',       jour: 'Lundi', date: '01/06/2026', h1: '19:30', h2: '20:00', sujet: '' },
  { nom: 'Fillod Noëline',  email: 'noeline.fillod@gmail.com',      jour: 'Lundi', date: '01/06/2026', h1: '20:00', h2: '20:30', sujet: '' },
  // Mardi 02/06/2026
  { nom: 'Copine Elijah',   email: 'elijah77400@gmail.com',         jour: 'Mardi', date: '02/06/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Mauriet Maëlys',  email: 'maelysmauriet@gmail.com',       jour: 'Mardi', date: '02/06/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'Célia Egue',      email: 'ainaegue95@gmail.com',          jour: 'Mardi', date: '02/06/2026', h1: '19:30', h2: '20:00', sujet: '' },
  { nom: 'Yilmaz Evan',     email: 'evanyilmaz08@gmail.com',        jour: 'Mardi', date: '02/06/2026', h1: '20:00', h2: '20:30', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(20)} ${s.email.padEnd(38)} ${s.jour} ${s.date} ${s.h1}-${s.h2}  → `)
  try {
