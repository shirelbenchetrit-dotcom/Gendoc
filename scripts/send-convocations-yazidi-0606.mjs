// Envoi convocations - Mme Dounia Yazidi - PC - Samedi 06/06/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-yazidi-0606.mjs
...
const students = [
  { nom: 'Giraud Naelie',                  email: 'naeliegiraud@icloud.com',     h1: '08:30', h2: '09:00', sujet: '' },
  { nom: 'DUBOIS Ambre',                   email: 'ambre.dubois2008@gmail.com',  h1: '09:00', h2: '09:30', sujet: "Pourquoi le corps frissonne-t-il lors d'une montée de fièvre ?" },
  { nom: 'Bougouin Lenny',                 email: 'Len.bou1475@gmail.com',       h1: '09:30', h2: '10:00', sujet: '' },
  { nom: 'Pillier Louna',                  email: 'Lounapiller@hotmail.com',     h1: '10:00', h2: '10:30', sujet: '' },
  { nom: 'Spitale Adam',                   email: 'adam.spitale@gmail.com',      h1: '10:30', h2: '11:00', sujet: '' },
  { nom: 'Shane Segard',                   email: 'shanebni@hotmail.com',        h1: '11:00', h2: '11:30', sujet: '' },
  { nom: 'Joey Sarfati',                   email: 'sarfatijoey@gmail.com',       h1: '11:30', h2: '12:00', sujet: '' },
  { nom: 'El boujidi Ines',                email: 'ineselboujidi393@gmail.com',  h1: '12:00', h2: '12:30', sujet: '' },
  { nom: 'Tegny Richard',                  email: 'tegnyrichard@gmail.com',      h1: '12:30', h2: '13:00', sujet: '' },
  { nom: 'MENIDIOH Logan',                 email: 'logmnd08@gmail.com',          h1: '14:00', h2: '14:30', sujet: '' },
  { nom: 'Dassé Margaux',                  email: 'margdasse@gmail.com',         h1: '14:30', h2: '15:00', sujet: '' },
  { nom: 'Sanogo Kadidja',                 email: 'kadidjasanogo156@gmail.com',  h1: '15:00', h2: '15:30', sujet: '' },
  { nom: 'Nicolas Borderie',               email: 'nicolasborderie81@gmail.com', h1: '15:30', h2: '16:00', sujet: '' },
  { nom: 'Labourasse Margot',              email: 'Solene.labourasse@gmail.com', h1: '16:00', h2: '16:30', sujet: '' },
  { nom: 'Pierre Amélia',                  email: 'amelia.pierre2025@gmail.com', h1: '16:30', h2: '17:00', sujet: '' },
  { nom: 'Badaoui Soumeyya',               email: 'soumeyyabadaoui@gmail.com',   h1: '17:00', h2: '17:30', sujet: '' },
  { nom: 'Andre Madeline',                 email: 'themadelineandre@gmail.com',  h1: '17:30', h2: '18:00', sujet: '' },
  { nom: 'Nkengue nanke Nadine Patricia',  email: 'nkenguenanke@gmail.com',      h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Ould Braham Lyes',               email: 'ouldbrahamlyes@yahoo.com',    h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Lina Sebbane',                   email: 'linasebbane3@gmail.com',      h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'Flici Cintia',                   email: 'flicicintia08@gmail.com',     h1: '19:30', h2: '20:00', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(34)} ${s.email.padEnd(38)} ${s.h1}-${s.h2}  → `)
  try {
