// Renvoi convocation Castille - avec bandeau "annulation 17/05 + nouvelle date 24/05"
// Usage : node scripts/send-convocation-castille-2405-v2.mjs
...
const s = {
  nom: 'Castille Drüeke',
  email: 'castille2008@gmail.com',
  h1: '19:30',
  h2: '20:00',
  sujet: "Avec les connaissances médicales actuelles, aurait-on pu sauver Anne d'Autriche de son cancer ?",
}
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#eef2f6;padding:32px 0;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 4px 18px rgba(0,0,0,0.08);">
        ...
        <!-- Bandeau "annulation + nouvelle date" -->
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#fef3c7;border-left:4px solid #d97706;border-radius:0 8px 8px 0;">
            <tr><td style="padding:14px 18px;">
              <p style="margin:0;color:#78350f;font-size:13px;line-height:1.55;">
                📌 <strong>Important : ton oral SVT a été déplacé.</strong> Date finale : <strong>lundi 18/05/2026 à 19:30</strong> (cf. détails ci-dessous). Merci de ne pas tenir compte des convocations précédentes.
              </p>
            </td></tr>
          </table>
        </td></tr>
