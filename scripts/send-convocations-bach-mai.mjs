// Envoi convocations - M. Mathieu Bach - Physique-Chimie - Mai 2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-bach-mai.mjs
...
const COMMON = {
  ...
  professeur: 'M. Mathieu Bach',
  formulaireSujet: 'https://forms.gle/5pDtPWepFKDJBiNh9',
}

const students = [
  // Lundi 18/05/2026
  { nom: 'Halifi Ethan',           email: 'halifiethan@icloud.com',           jour: 'Lundi',    date: '18/05/2026', h1: '16:30', h2: '17:00', sujet: "Une mission habitée vers Mars est-elle réellement envisageable dès les années 2030 ?" },
  { nom: 'Bijon Evie',             email: 'Eviebijon92@gmail.com',            jour: 'Lundi',    date: '18/05/2026', h1: '17:00', h2: '17:30', sujet: '' },
  { nom: 'Diaz Maé',               email: 'diazmae679@gmail.com',             jour: 'Lundi',    date: '18/05/2026', h1: '17:30', h2: '18:00', sujet: '' },
  // Mardi 19/05/2026
  { nom: 'Slaim Sandrine',         email: 'sandrineslaim@gmail.com',          jour: 'Mardi',    date: '19/05/2026', h1: '17:00', h2: '17:30', sujet: "Comment les interactions moléculaires expliquent-elles la non-miscibilité entre l'eau et l'huile ?" },
  { nom: 'Dinh Lisiane',           email: 'lisiane.dinh08@gmail.com',         jour: 'Mardi',    date: '19/05/2026', h1: '17:30', h2: '18:00', sujet: '' },
  // Mercredi 20/05/2026
  { nom: 'Kemmache Ines',          email: 'kemmacheinesbp@gmail.com',         jour: 'Mercredi', date: '20/05/2026', h1: '17:00', h2: '17:30', sujet: '' },
  { nom: 'Lina Mekita',            email: 'linamkt18@gmail.com',              jour: 'Mercredi', date: '20/05/2026', h1: '17:30', h2: '18:00', sujet: '' },
  // Jeudi 21/05/2026
  { nom: 'Bos Juliette',           email: 'juliettebos2008@icloud.com',       jour: 'Jeudi',    date: '21/05/2026', h1: '17:30', h2: '18:00', sujet: '' },
  { nom: 'Solene Loussouarn',      email: 'solene.loussouarn@outlook.fr',     jour: 'Jeudi',    date: '21/05/2026', h1: '18:00', h2: '18:30', sujet: '' },
  // Samedi 23/05/2026
  { nom: 'Bérénice Dupuy-Guérin',  email: 'berenicedupuyguerin@gmail.com',    jour: 'Samedi',   date: '23/05/2026', h1: '09:30', h2: '10:00', sujet: '' },
  { nom: 'Claire Affret-Jas',      email: 'claireaffretjas08@yahoo.com',      jour: 'Samedi',   date: '23/05/2026', h1: '10:00', h2: '10:30', sujet: "Stéréochimie moléculaire : quand soigner revient à risquer d'empoisonner, le cas de la Thalidomide." },
  { nom: 'Alexane Mawusi',         email: 'alexanemawusi@icloud.com',         jour: 'Samedi',   date: '23/05/2026', h1: '10:30', h2: '11:00', sujet: "En quoi la couleur des animaux peut s'expliquer par des phénomènes physiques et permettre la survie de certaines espèces ?" },
  { nom: 'Adama Hawa Bah',         email: 'adamahawabahkindia@gmail.com',     jour: 'Samedi',   date: '23/05/2026', h1: '11:00', h2: '11:30', sujet: '' },
  { nom: 'Kaddour Amine',          email: 'amine.kaddour1@yahoo.com',         jour: 'Samedi',   date: '23/05/2026', h1: '11:30', h2: '12:00', sujet: '' },
  { nom: 'Anaelle Rath',           email: 'anaelle.rath@live.fr',             jour: 'Samedi',   date: '23/05/2026', h1: '12:00', h2: '12:30', sujet: '' },
  { nom: 'Léna Lambinet',          email: 'lena.lambinet29@gmail.com',        jour: 'Samedi',   date: '23/05/2026', h1: '12:30', h2: '13:00', sujet: "Les huiles essentielles sont-elles sans danger parce qu'elles sont naturelles ?" },
  { nom: 'Muzeyyen kerim',         email: 'muzeyyenkerim24@gmail.com',        jour: 'Samedi',   date: '23/05/2026', h1: '13:00', h2: '13:30', sujet: "La chimie peut-elle tout expliquer dans le paracétamol ?" },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(26)} ${s.email.padEnd(38)} ${s.jour.padEnd(8)} ${s.date} ${s.h1}-${s.h2}  → `)
  try {
