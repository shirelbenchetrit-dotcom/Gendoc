// Test v2 : convocation sans lien Zoom (envoyé le jour J), avec déroulé 10+10+10
// Usage : node scripts/test-convocation-v2.mjs
...
// === DONNÉES DE TEST (Maynis, comme la v1) ===
const data = {
...
const hasSujet = data.sujet && data.sujet.trim().length > 0
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#ecfdf5;border-left:4px solid #10b981;border-radius:0 10px 10px 0;">
            <tr><td style="padding:20px 22px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="font-size:13px;">
                ...
                <tr>
                  <td style="color:#64748b;padding:5px 0;vertical-align:top;">Connexion</td>
                  <td style="color:#334155;padding:5px 0;font-style:italic;line-height:1.5;">Le lien Zoom te sera envoyé par email <strong>le jour de l'oral</strong>.</td>
                </tr>
                <tr>
        ...
        <tr><td style="padding:0 40px 20px;">
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#eff6ff;border-left:4px solid #3b82f6;border-radius:0 10px 10px 0;">
            <tr><td style="padding:20px 22px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="font-size:13px;">
                <tr>
                  <td width="60" style="color:#1d4ed8;padding:5px 0;font-weight:700;vertical-align:top;">10 min</td>
                  <td style="color:#334155;padding:5px 0;line-height:1.5;">Présentation de ton sujet</td>
                </tr>
                <tr>
                  <td style="color:#1d4ed8;padding:5px 0;font-weight:700;vertical-align:top;">10 min</td>
                  <td style="color:#334155;padding:5px 0;line-height:1.5;">Questions du professeur</td>
                </tr>
                <tr>
                  <td style="color:#1d4ed8;padding:5px 0;font-weight:700;vertical-align:top;">10 min</td>
                  <td style="color:#334155;padding:5px 0;line-height:1.5;">Conseils pour ton vrai oral du Bac</td>
                </tr>
              </table>
            </td></tr>
          </table>
...
const payload = {
  ...
  subject: `[TEST v2] Convocation oral blanc — ${data.matiere} — ${data.jour} ${data.date}`,
  htmlContent,
}

console.log(`→ Envoi du test v2 à ${data.destinataire}...`)
...
console.log(`✓ Test v2 envoyé. ${respText}`)
