// Envoi convocations - Mme Benramdane - SVT - Mardi 19/05/2026
// Template v3 (mention Meet) + BCC à Shirel
// Usage : node scripts/send-convocations-benramdane-1905.mjs
...
const students = [
  { prenom: 'Chloé', email: 'chloelh26@gmail.com',       h1: '18:30', h2: '19:00', sujet: "Comment peut-on utiliser le métabolisme du sucre pour « affamer » les cellules cancéreuses et ainsi traiter la maladie ?" },
  { prenom: 'Maé',   email: 'diazmae679@gmail.com',      h1: '19:00', h2: '19:30', sujet: '' },
  { prenom: 'Lucas', email: 'Lucas.chanonier@gmail.com', h1: '20:30', h2: '21:00', sujet: '' },
]
