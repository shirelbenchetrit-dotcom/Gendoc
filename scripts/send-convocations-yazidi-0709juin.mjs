// Envoi convocations - Mme Dounia Yazidi - PC - Dim 07/06 + Mar 09/06/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-yazidi-0709juin.mjs
...
const students = [
  // Dimanche 07/06/2026
  { nom: 'Saleh Yara',           email: 'Yaray.saleh@gmail.com',         jour: 'Dimanche', date: '07/06/2026', h1: '09:00', h2: '09:30', sujet: '' },
  { nom: 'SOKHONA Rokhiya',      email: 'rokhiya.sokhona@outlook.com',   jour: 'Dimanche', date: '07/06/2026', h1: '09:30', h2: '10:00', sujet: '' },
  { nom: 'Takam Moché Nandi',    email: 'takamnandi268@gmail.com',       jour: 'Dimanche', date: '07/06/2026', h1: '10:00', h2: '10:30', sujet: '' },
  { nom: 'Elio Vaughan',         email: 'Elvievaughan83@gmail.com',      jour: 'Dimanche', date: '07/06/2026', h1: '10:30', h2: '11:00', sujet: '' },
  { nom: 'Sylvain Valls',        email: 'vallsyanis@gmail.com',          jour: 'Dimanche', date: '07/06/2026', h1: '11:00', h2: '11:30', sujet: '' },
  { nom: 'Azzati Khadija',       email: 'khadijaazzati@gmail.com',       jour: 'Dimanche', date: '07/06/2026', h1: '14:30', h2: '15:00', sujet: '' },
  { nom: 'Houssard Augustin',    email: 'gushou09@orange.fr',            jour: 'Dimanche', date: '07/06/2026', h1: '15:00', h2: '15:30', sujet: '' },
  { nom: 'Boronad Alexandre',    email: 'alexandreboronad1@gmail.com',   jour: 'Dimanche', date: '07/06/2026', h1: '15:30', h2: '16:00', sujet: '' },
  { nom: 'Zerrouni Sara',        email: 'norahouas5@gmail.com',          jour: 'Dimanche', date: '07/06/2026', h1: '16:00', h2: '16:30', sujet: '' },
  { nom: 'Diawara Camara Fama',  email: 'famadiawara86@gmail.com',       jour: 'Dimanche', date: '07/06/2026', h1: '16:30', h2: '17:00', sujet: '' },
  { nom: 'Hugo Schwartz',        email: 'hugoschwartz38@gmail.com',      jour: 'Dimanche', date: '07/06/2026', h1: '17:00', h2: '17:30', sujet: '' },
  { nom: 'Shapiro Lilly',        email: 'lillyshap@icloud.com',          jour: 'Dimanche', date: '07/06/2026', h1: '17:30', h2: '18:00', sujet: '' },
  { nom: 'Kadadi Rajae',         email: 'kadadirajae@gmail.com',         jour: 'Dimanche', date: '07/06/2026', h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Ufer Morgan',          email: 'morgan.ufer@gmail.com',         jour: 'Dimanche', date: '07/06/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Chasle Susie',         email: 'susiechasle@gmail.com',         jour: 'Dimanche', date: '07/06/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'Bourgois Hugo',        email: 'hguobourgois@gmail.com',        jour: 'Dimanche', date: '07/06/2026', h1: '19:30', h2: '20:00', sujet: '' },
  // Mardi 09/06/2026
  { nom: 'Lahssioui Inès',       email: 'lahssiouiines@gmail.com',       jour: 'Mardi',    date: '09/06/2026', h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Oray Julie',           email: 'orayjulie44@gmail.com',         jour: 'Mardi',    date: '09/06/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Raphael Vidal',        email: 'raph.vidal@icloud.com',         jour: 'Mardi',    date: '09/06/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'Dintzner Clément',     email: 'clemdintzner@gmail.com',        jour: 'Mardi',    date: '09/06/2026', h1: '20:00', h2: '20:30', sujet: '' },
  { nom: 'Jeanne Bouix',         email: 'Bouixjeanne@gmail.com',         jour: 'Mardi',    date: '09/06/2026', h1: '20:30', h2: '21:00', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(22)} ${s.email.padEnd(36)} ${s.jour.padEnd(8)} ${s.date} ${s.h1}-${s.h2}  → `)
  try {
