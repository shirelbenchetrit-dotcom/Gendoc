// Envoi convocations - Mme Vanessa Cohen - Maths - Dim 07/06 + Lun 08/06/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-cohen-0708juin.mjs
...
const COMMON = {
  ...
  professeur: 'Mme Vanessa Cohen',
  formulaireSujet: 'https://forms.gle/5pDtPWepFKDJBiNh9',
}

const students = [
  // Dimanche 07/06/2026
  { nom: 'Lina Sebbane',       email: 'linasebbane3@gmail.com',         jour: 'Dimanche', date: '07/06/2026', h1: '09:30', h2: '10:00', sujet: "Dans quelle mesure les mathématiques permettent-elles de garantir la sécurité d'une anesthésie ?" },
  { nom: 'DUBOIS Ambre',       email: 'ambre.dubois2008@gmail.com',     jour: 'Dimanche', date: '07/06/2026', h1: '10:00', h2: '10:30', sujet: "En quoi le nombre d'or se retrouve-t-il dans la nature et dans l'art ?" },
  { nom: 'Labourasse Margot',  email: 'Solene.labourasse@gmail.com',    jour: 'Dimanche', date: '07/06/2026', h1: '10:30', h2: '11:00', sujet: '' },
  { nom: 'Badaoui Soumeyya',   email: 'soumeyyabadaoui@gmail.com',      jour: 'Dimanche', date: '07/06/2026', h1: '11:00', h2: '11:30', sujet: '' },
  { nom: 'SOKHONA Rokhiya',    email: 'rokhiya.sokhona@outlook.com',    jour: 'Dimanche', date: '07/06/2026', h1: '11:30', h2: '12:00', sujet: '' },
  { nom: 'Ufer Morgan',        email: 'morgan.ufer@gmail.com',          jour: 'Dimanche', date: '07/06/2026', h1: '12:30', h2: '13:00', sujet: '' },
  { nom: 'Alcime Edna',        email: 'ednaalcime18@gmail.com',         jour: 'Dimanche', date: '07/06/2026', h1: '14:00', h2: '14:30', sujet: '' },
  { nom: 'Mestouri Jade',      email: 'mestourijade@gmail.com',         jour: 'Dimanche', date: '07/06/2026', h1: '14:30', h2: '15:00', sujet: '' },
  { nom: 'El Boujidi Ines',    email: 'ineselboujidi393@gmail.com',     jour: 'Dimanche', date: '07/06/2026', h1: '15:00', h2: '15:30', sujet: '' },
  { nom: 'Nouhaud Maelys',     email: 'nouhaudmaelys@gmail.com',        jour: 'Dimanche', date: '07/06/2026', h1: '15:30', h2: '16:00', sujet: '' },
  { nom: 'Belouar Amira',      email: 'abelouar.17@gmail.com',          jour: 'Dimanche', date: '07/06/2026', h1: '17:30', h2: '18:00', sujet: '' },
  { nom: 'Bourgois Hugo',      email: 'hguobourgois@gmail.com',         jour: 'Dimanche', date: '07/06/2026', h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Flici Cintia',       email: 'flicicintia08@gmail.com',        jour: 'Dimanche', date: '07/06/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Saleh Yara',         email: 'Yaray.saleh@gmail.com',          jour: 'Dimanche', date: '07/06/2026', h1: '19:00', h2: '19:30', sujet: '' },
  // Lundi 08/06/2026
  { nom: 'Raphael Vidal',      email: 'raph.vidal@icloud.com',          jour: 'Lundi', date: '08/06/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'ELAWDALA Jacques',   email: 'jacqueselawdala@gmail.com',      jour: 'Lundi', date: '08/06/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'El baz Agier Jade',  email: 'jade.elbaz@outlook.fr',          jour: 'Lundi', date: '08/06/2026', h1: '19:30', h2: '20:00', sujet: '' },
  { nom: 'Fleury Margot',      email: 'margotfleury25@gmail.com',       jour: 'Lundi', date: '08/06/2026', h1: '20:00', h2: '20:30', sujet: '' },
  { nom: 'Dintzner Clément',   email: 'clemdintzner@gmail.com',         jour: 'Lundi', date: '08/06/2026', h1: '20:30', h2: '21:00', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(22)} ${s.email.padEnd(38)} ${s.jour} ${s.date} ${s.h1}-${s.h2}  → `)
  try {
