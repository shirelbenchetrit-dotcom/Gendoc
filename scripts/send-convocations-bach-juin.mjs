// Envoi convocations - M. Mathieu Bach - Physique-Chimie - Mar 02/06 + Lun 08/06/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-bach-juin.mjs
...
const students = [
  // Mardi 02/06/2026
  { nom: 'Shaily Zenati',            email: 'zenatishaily@gmail.com',         jour: 'Mardi', date: '02/06/2026', h1: '10:30', h2: '11:00', sujet: '' },
  { nom: 'RUPRECHT Clémence',        email: 'clemence.ruprecht@gmail.com',    jour: 'Mardi', date: '02/06/2026', h1: '11:00', h2: '11:30', sujet: '' },
  { nom: 'ELAWDALA Jacques',         email: 'jacqueselawdala@gmail.com',      jour: 'Mardi', date: '02/06/2026', h1: '11:30', h2: '12:00', sujet: '' },
  { nom: 'Ghazal Louanne',           email: 'louanneghazal@icloud.com',       jour: 'Mardi', date: '02/06/2026', h1: '12:00', h2: '12:30', sujet: '' },
  // Lundi 08/06/2026
  { nom: 'El baz Agier Jade',        email: 'jade.elbaz@outlook.fr',          jour: 'Lundi', date: '08/06/2026', h1: '10:00', h2: '10:30', sujet: '' },
  { nom: 'HUET de GUERVILLE Agathe', email: 'agathe.huetdeg@gmail.com',       jour: 'Lundi', date: '08/06/2026', h1: '11:00', h2: '11:30', sujet: '' },
  { nom: 'Loyson Cléo',              email: 'clk4621@gmail.com',              jour: 'Lundi', date: '08/06/2026', h1: '11:30', h2: '12:00', sujet: '' },
  { nom: 'Halbout Warot Marine',     email: 'Marinehalboutwarot@gmail.com',   jour: 'Lundi', date: '08/06/2026', h1: '17:00', h2: '17:30', sujet: '' },
  { nom: 'Laffitte Alexia',          email: 'alexia.laffitte75@gmail.com',    jour: 'Lundi', date: '08/06/2026', h1: '17:30', h2: '18:00', sujet: "Comment la protonthérapie révolutionne le traitement contre le cancer ?" },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(28)} ${s.email.padEnd(38)} ${s.jour} ${s.date} ${s.h1}-${s.h2}  → `)
  try {
