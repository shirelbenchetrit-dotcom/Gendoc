// Envoi solo - Ness Benarroch - Maths Cohen - Dim 24/05/2026 19:30 (déplacé à sa demande)
// Usage : node scripts/send-convocation-ness-2405.mjs
...
const s = {
  nom: 'Ness Benarroch',
  email: 'nessesther.benarroch@gmail.com',
  h1: '19:30',
  h2: '20:00',
  sujet: "Comment les mathématiques peuvent sauver les diabétiques ?",
}
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#fef3c7;border-left:4px solid #d97706;border-radius:0 8px 8px 0;">
            <tr><td style="padding:14px 18px;">
              <p style="margin:0;color:#78350f;font-size:13px;line-height:1.55;">
                📌 <strong>Comme convenu, ton oral de Mathématiques a été déplacé à ta demande.</strong> Nouvelle date : <strong>dimanche 24/05/2026 à 19:30</strong> (cf. détails ci-dessous). Merci de ne pas tenir compte de la convocation précédente.
              </p>
            </td></tr>
          </table>
        </td></tr>
