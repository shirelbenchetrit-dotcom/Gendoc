// Envoi convocations - M. Gabriel Boccara - Physique-Chimie - Dimanche 17/05/2026
// Template v2 (sans lien Zoom dans le mail, déroulé 10+10+10)
// Usage : node scripts/send-convocations-boccara.mjs
...
const students = [
  { prenom: 'Carole',   email: 'c.pegain@gmail.com',           h1: '14:00', h2: '14:30', sujet: '' },
  { prenom: 'Jeanne',   email: 'jeannelecanu86@gmail.com',     h1: '14:30', h2: '15:00', sujet: "En quoi les avancées physicochimiques permettent-elles de détecter et traiter la spondylarthrite ankylosante ?" },
  { prenom: 'Yara',     email: 'sedirayararazane@gmail.com',   h1: '15:00', h2: '15:30', sujet: '' },
  { prenom: 'Angèle',   email: 'angelebidet@gmail.com',        h1: '15:30', h2: '16:00', sujet: '' },
  { prenom: 'Castille', email: 'castille2008@gmail.com',       h1: '16:00', h2: '16:30', sujet: '' },
  { prenom: 'Margot',   email: 'margotjacob95@gmail.com',      h1: '16:30', h2: '17:00', sujet: "Comment les lois de la physique interviennent-elles dans le saut d'obstacles ?" },
  { prenom: 'Gisèle',   email: 'giselevermer18@gmail.com',     h1: '17:30', h2: '18:00', sujet: "Comment guérir la bipolarité ? (la chimie des médicaments)" },
]
