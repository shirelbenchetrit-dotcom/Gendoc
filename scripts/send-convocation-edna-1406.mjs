// Envoi solo - Alcime Edna - SVT Benramdane - Dim 14/06/2026 19:00 (correction : Maths annulée)
// Usage : node scripts/send-convocation-edna-1406.mjs
...
const s = {
  nom: 'Alcime Edna',
  email: 'ednaalcime18@gmail.com',
  h1: '19:00',
  h2: '19:30',
  sujet: '',
}

const sujetCell = s.sujet && s.sujet.trim().length > 0
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#eef2f6;padding:32px 0;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 4px 18px rgba(0,0,0,0.08);">
        ...
        <!-- Bandeau "correction : Maths annulé, c'est SVT" -->
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#fef3c7;border-left:4px solid #d97706;border-radius:0 8px 8px 0;">
            <tr><td style="padding:14px 18px;">
              <p style="margin:0;color:#78350f;font-size:13px;line-height:1.55;">
                📌 <strong>Important — correction :</strong> ton oral de Mathématiques (initialement prévu dim 07/06) est <strong>annulé</strong>. Tu passes en réalité un oral de <strong>SVT</strong>, dont les détails sont ci-dessous. Merci de ne pas tenir compte de la convocation Maths.
              </p>
            </td></tr>
          </table>
        </td></tr>
...
const payload = {
  ...
  subject: `[Correction] Convocation oral blanc — ${COMMON.matiere} — ${COMMON.jour} ${COMMON.date}`,
  htmlContent,
}

console.log(`→ Envoi à ${s.email}...`)
