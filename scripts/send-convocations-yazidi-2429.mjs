// Envoi convocations - Mme Dounia Yazidi - Physique-Chimie - Dim 24/05 → Ven 29/05/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-yazidi-2429.mjs
...
const students = [
  // Dimanche 24/05/2026
  { nom: 'Louise trarieux',          email: 'louisetrarieux@icloud.com',       jour: 'Dimanche', date: '24/05/2026', h1: '16:00', h2: '16:30', sujet: "Aurait-on pu sauver Marie Curie ?" },
  { nom: 'Cimik Ela',                email: 'ela.cimik12@gmail.com',           jour: 'Dimanche', date: '24/05/2026', h1: '16:30', h2: '17:00', sujet: '' },
  { nom: 'Sivapatham Abhi',          email: 'Abhisivapatham@gmail.com',        jour: 'Dimanche', date: '24/05/2026', h1: '17:00', h2: '17:30', sujet: '' },
  { nom: 'Gabaud Ilya',              email: 'ilya.gabauds@gmail.com',          jour: 'Dimanche', date: '24/05/2026', h1: '17:30', h2: '18:00', sujet: '' },
  { nom: 'Rafael Piquerey',          email: 'rafael.piquerey@gmail.com',       jour: 'Dimanche', date: '24/05/2026', h1: '18:00', h2: '18:30', sujet: "Pourquoi le service flottant au volleyball a-t-il une trajectoire aussi imprévisible comparée aux autres services ?" },
  { nom: 'Kouyate - Percherin Mina', email: 'mina.kouyate.percherin@gmail.com',jour: 'Dimanche', date: '24/05/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Mathis Pourre',            email: 'mirvari@yahoo.fr',                jour: 'Dimanche', date: '24/05/2026', h1: '19:00', h2: '19:30', sujet: "En quoi la physique des rayons X permet de localiser des tumeurs à l'aide de techniques radiographiques ?" },
  // Mardi 26/05/2026
  { nom: 'Yohai Bitton',             email: 'yohaibitton@icloud.com',          jour: 'Mardi',    date: '26/05/2026', h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Levy Samuel',              email: 'Samuellevy2008@gmail.com',        jour: 'Mardi',    date: '26/05/2026', h1: '18:30', h2: '19:00', sujet: "Comment les lois physiques de la décroissance radioactive permettent-elles de traiter et de diagnostiquer des maladies comme le cancer ?" },
  { nom: 'Goujard Eliot',            email: 'eliot.goujard@gmail.com',         jour: 'Mardi',    date: '26/05/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'Schapira Azalee',          email: 'schapiraazalee@gmail.com',        jour: 'Mardi',    date: '26/05/2026', h1: '20:00', h2: '20:30', sujet: '' },
  { nom: 'Sqdi Jasmine',             email: 'jasminesadi213@gmail.com',        jour: 'Mardi',    date: '26/05/2026', h1: '20:30', h2: '21:00', sujet: '' },
  // Jeudi 28/05/2026
  { nom: 'Gabaston Maëlle',          email: 'mama.gabaston@gmail.com',         jour: 'Jeudi',    date: '28/05/2026', h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Aziz ZAGHLOUL Abanob',     email: '45abanob@gmail.com',              jour: 'Jeudi',    date: '28/05/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Jade Beuneche',            email: 'jadebeuneche@gmail.com',          jour: 'Jeudi',    date: '28/05/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'Daguenet Elisa',           email: 'elisa.daguenet@free.fr',          jour: 'Jeudi',    date: '28/05/2026', h1: '20:00', h2: '20:30', sujet: '' },
  { nom: 'Ruiz Alexis',              email: 'alexistheboss08@icloud.com',      jour: 'Jeudi',    date: '28/05/2026', h1: '20:30', h2: '21:00', sujet: '' },
  // Vendredi 29/05/2026
  { nom: 'Roger Madeleine',          email: 'madeleineroger@yahoo.com',        jour: 'Vendredi', date: '29/05/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Jolibert Eléa',            email: 'eleajolibert@gmail.com',          jour: 'Vendredi', date: '29/05/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'Thomas Eva',               email: 'evathomastricault@yahoo.com',     jour: 'Vendredi', date: '29/05/2026', h1: '20:00', h2: '20:30', sujet: '' },
  { nom: 'Saouabi Yasmine',          email: 'yassaoubi@gmail.com',             jour: 'Vendredi', date: '29/05/2026', h1: '20:30', h2: '21:00', sujet: '' },
]
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 4px 18px rgba(0,0,0,0.08);">
        ...
        <tr><td style="padding:36px 40px 8px;">
          ...
          <p style="color:#334155;font-size:14px;line-height:1.65;margin:0 0 4px;">
            Tu es convoqué(e) à un <strong>oral blanc</strong> le <strong>${s.jour.toLowerCase()} ${s.date}</strong>.
          </p>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#ecfdf5;border-left:4px solid #10b981;border-radius:0 10px 10px 0;">
            <tr><td style="padding:20px 22px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="font-size:13px;">
                <tr><td width="120" style="color:#64748b;padding:5px 0;vertical-align:top;">Date</td><td style="color:#0f172a;padding:5px 0;font-weight:600;">${s.jour} ${s.date}</td></tr>
...
async function sendOne(s) {
  const payload = {
    ...
    subject: `Convocation oral blanc — ${COMMON.matiere} — ${s.jour} ${s.date}`,
...
console.log(`→ Envoi de ${students.length} convocations (${COMMON.professeur} - ${COMMON.matiere})...\n`)
const results = []
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(28)} ${s.email.padEnd(38)} ${s.jour.padEnd(8)} ${s.date} ${s.h1}-${s.h2}  → `)
  try {
