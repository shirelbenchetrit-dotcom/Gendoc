// Envoi convocations - Mme Benramdane - SVT - Lundi 01/06 + Mardi 02/06/2026
// Template v3 (Meet) + BCC
// Usage : node scripts/send-convocations-benramdane-0102juin.mjs
...
const students = [
  // Lundi 01/06/2026
  { prenom: 'Emma',      email: 'edml750131@gmail.com',           jour: 'Lundi', date: '01/06/2026', h1: '16:00', h2: '16:30', sujet: '' },
  { prenom: 'Viktoriia', email: 'viktoriia2022dm@gmail.com',      jour: 'Lundi', date: '01/06/2026', h1: '16:30', h2: '17:00', sujet: '' },
  { prenom: 'Noor',      email: 'noor.rakid@gmail.com',           jour: 'Lundi', date: '01/06/2026', h1: '17:00', h2: '17:30', sujet: '' },
  { prenom: 'Shaily',    email: 'zenatishaily@gmail.com',         jour: 'Lundi', date: '01/06/2026', h1: '17:30', h2: '18:00', sujet: '' },
  { prenom: 'Jade',      email: 'Jadeschatz32@gmail.com',         jour: 'Lundi', date: '01/06/2026', h1: '18:00', h2: '18:30', sujet: '' },
  { prenom: 'Samia',     email: 'Sdj190208@gmail.com',            jour: 'Lundi', date: '01/06/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { prenom: 'Aya',       email: 'ayaboukhchina27@gmail.com',      jour: 'Lundi', date: '01/06/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { prenom: 'Abou',      email: 'sow.abous@laposte.net',          jour: 'Lundi', date: '01/06/2026', h1: '20:00', h2: '20:30', sujet: '' },
  // Mardi 02/06/2026
  { prenom: 'Eliott',    email: 'eliott.buchser@gmail.com',       jour: 'Mardi', date: '02/06/2026', h1: '18:00', h2: '18:30', sujet: '' },
  { prenom: 'Maxime',    email: 'maxime.moulin.ponte@gmail.com',  jour: 'Mardi', date: '02/06/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { prenom: 'Lili-Rose', email: 'liliroseforget@gmail.com',       jour: 'Mardi', date: '02/06/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { prenom: 'Evan',      email: 'evanyilmaz08@gmail.com',         jour: 'Mardi', date: '02/06/2026', h1: '19:30', h2: '20:00', sujet: '' },
  { prenom: 'Emmie',     email: 'emmie.girard0601@gmail.com',     jour: 'Mardi', date: '02/06/2026', h1: '20:00', h2: '20:30', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.prenom.padEnd(10)} ${s.email.padEnd(38)} ${s.jour} ${s.date} ${s.h1}-${s.h2}  → `)
  try {
