// Envoi convocations - Mme Benramdane - SVT - Lundi 08/06/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-benramdane-0806.mjs
...
const students = [
  { nom: 'HUET de GUERVILLE Agathe', email: 'agathe.huetdeg@gmail.com',     h1: '11:30', h2: '12:00', sujet: '' },
  { nom: 'Ghazal Louanne',           email: 'louanneghazal@icloud.com',     h1: '12:00', h2: '12:30', sujet: '' },
  { nom: 'Lahssioui Inès',           email: 'lahssiouiines@gmail.com',      h1: '12:30', h2: '13:00', sujet: '' },
  { nom: 'Oray Julie',               email: 'orayjulie44@gmail.com',        h1: '13:00', h2: '13:30', sujet: '' },
  { nom: 'Halbout Warot Marine',     email: 'Marinehalboutwarot@gmail.com', h1: '17:30', h2: '18:00', sujet: '' },
  { nom: 'Jeanne Bouix',             email: 'Bouixjeanne@gmail.com',        h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Laffitte Alexia',          email: 'alexia.laffitte75@gmail.com',  h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Fleury Margot',            email: 'margotfleury25@gmail.com',     h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'Tanguy Manon',             email: 'Manontanguy656@gmail.com',     h1: '20:00', h2: '20:30', sujet: '' },
  { nom: 'Inès Marchal',             email: 'ines.marchal14@gmail.com',     h1: '20:30', h2: '21:00', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(28)} ${s.email.padEnd(36)} ${s.h1}-${s.h2}  → `)
  try {
