// Envoi convocations - Mme Vanessa Cohen - Maths - Dimanche 31/05/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-cohen-3105.mjs
...
const students = [
  { nom: "Daria Guillemain d'Echon", email: 'daria.guillemain@icloud.com',   h1: '09:00', h2: '09:30', sujet: '' },
  { nom: 'Amadou Ali Amyra',         email: 'amiraamadouali08@gmail.com',    h1: '09:30', h2: '10:00', sujet: '' },
  { nom: 'besse mathilde',           email: 'mathilde.besse@yahoo.com',      h1: '10:00', h2: '10:30', sujet: "Comment les modèles mathématiques permettent-ils de comprendre et prévoir l'évolution d'une épidémie comme la grippe en 2018 ?" },
  { nom: 'CHKILIT Noriane',          email: 'chkilitn@gmail.com',            h1: '10:30', h2: '11:00', sujet: "Comment prévoir l'évolution d'une tumeur à l'aide de fonctions mathématiques ?" },
  { nom: 'LOCOH-DONOU Olivia',       email: 'olivialocoh@icloud.com',        h1: '11:00', h2: '11:30', sujet: '' },
  { nom: 'Ben Mohamed Ghalia',       email: 'ghaliabenmohamed897@gmail.com', h1: '11:30', h2: '12:00', sujet: '' },
  { nom: 'Koffi Solène',             email: 'ksolene89@gmail.com',           h1: '12:00', h2: '12:30', sujet: '' },
  { nom: 'Boulegroune Naëlle',       email: 'naelle.boulegroune@gmail.com',  h1: '14:00', h2: '14:30', sujet: '' },
  { nom: 'KHEMICI Arys',             email: 'aryskhemici@gmail.com',         h1: '14:30', h2: '15:00', sujet: '' },
  { nom: 'Schaeffer Antigone',       email: 'antigoneschaeffer@riseup.net',  h1: '15:00', h2: '15:30', sujet: "Combien de temps nous reste-t-il avant que le réchauffement climatique soit irréversible ?" },
  { nom: 'Muhammad Aliza Khan',      email: 'Alizaakhann.93@gmail.com',      h1: '15:30', h2: '16:00', sujet: "Pourquoi une population ne peut-elle pas croître indéfiniment ?" },
  { nom: 'Balme Gail Charlotte',     email: 'charlottebg78@gmail.com',       h1: '16:00', h2: '16:30', sujet: '' },
  { nom: 'Bejtetyene Enjy',          email: 'enjad.2008@gmail.com',          h1: '16:30', h2: '17:00', sujet: "Comment les maths aident-elles la police scientifique à déterminer le délai post mortem ?" },
  { nom: 'Chassan Lisa',             email: 'lisa.xuemei@gmail.com',         h1: '17:00', h2: '17:30', sujet: '' },
  { nom: "m'barki Inès",             email: 'ghizlenehadri2@gmail.com',      h1: '17:30', h2: '18:00', sujet: '' },
  { nom: 'Makosso Christyvie Wise',  email: 'christyviewise08@icloud.com',   h1: '18:00', h2: '18:30', sujet: "En quoi les statistiques peuvent-elles nous induire en erreur ?" },
  { nom: 'Lyes Ould braham',         email: 'ouldbrahamlyes@yahoo.com',      h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Amine DREG',               email: 'adj021108@gmail.com',           h1: '19:00', h2: '19:30', sujet: "Les mathématiques sont-elles le meilleur moyen de modéliser la baisse de température du corps ?" },
  { nom: 'AL MOHAMMAD Hussein',      email: 'husseinalmohammad266@gmail.com',h1: '19:30', h2: '20:00', sujet: '' },
  { nom: 'Tran Sara',                email: 'sara.tran947@gmail.com',        h1: '20:00', h2: '20:30', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(28)} ${s.email.padEnd(40)} ${s.h1}-${s.h2}  → `)
  try {
