// Renvoi à Marie Raymond Yammine avec sujet corrigé
// Usage : node scripts/send-convocation-marie-update.mjs
...
const s = {
  prenom: 'Marie',
  email: 'marieraymondyammine@outlook.com',
  h1: '16:00', h2: '16:30',
  sujet: "Comment un stimulateur cardiaque est-il capable de remplacer le fonctionnement naturel du cœur ?",
}
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 4px 18px rgba(0,0,0,0.08);">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#fef3c7;border-left:4px solid #d97706;border-radius:0 8px 8px 0;">
            <tr><td style="padding:14px 18px;">
              <p style="margin:0;color:#78350f;font-size:13px;line-height:1.55;">
                📌 <strong>Cette convocation remplace celle envoyée précédemment</strong> — l'énoncé de ton sujet avait été tronqué dans le mail précédent. Merci de te référer à celle-ci.
              </p>
            </td></tr>
          </table>
        </td></tr>
        ...
        <tr><td style="padding:24px 40px 8px;">
          ...
          <p style="color:#334155;font-size:14px;line-height:1.65;margin:0 0 4px;">
            Tu es convoquée à un <strong>oral blanc</strong> le <strong>${COMMON.jour.toLowerCase()} ${COMMON.date}</strong>.
          </p>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#ecfdf5;border-left:4px solid #10b981;border-radius:0 10px 10px 0;">
            <tr><td style="padding:20px 22px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="font-size:13px;">
                ...
                <tr><td style="color:#64748b;padding:5px 0;vertical-align:top;">Ton sujet</td><td style="color:#334155;padding:5px 0;font-style:italic;line-height:1.5;">${s.sujet}</td></tr>
              </table>
            </td></tr>
          </table>
        </td></tr>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f1f5f9;border-radius:10px;">
            <tr><td style="padding:18px 22px;">
              ...
              <ul style="margin:0;padding-left:20px;color:#334155;font-size:13px;line-height:1.7;">
                <li>Sois prête <strong>5 minutes avant</strong> l'heure prévue</li>
...
console.log(`→ Envoi update à ${s.email}...`)
...
console.log(`✓ Mail envoyé. ${respText}`)
