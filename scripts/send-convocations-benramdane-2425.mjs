// Envoi convocations - Mme Benramdane - SVT - Dim 24/05 + Lun 25/05/2026
// Template v3 (Meet) + BCC
// Usage : node scripts/send-convocations-benramdane-2425.mjs
...
const students = [
  // Dimanche 24/05/2026
  { prenom: 'Lucas',     email: 'lulunoug82@gmail.com',          jour: 'Dimanche', date: '24/05/2026', h1: '13:30', h2: '14:00', sujet: "Pourquoi l'agent VX est-il si dangereux pour le corps humain, et quels sont les moyens actuels pour y remédier ?" },
  { prenom: 'Fleur',     email: 'fleur.lemoine25@gmail.com',     jour: 'Dimanche', date: '24/05/2026', h1: '14:00', h2: '14:30', sujet: '' },
  { prenom: 'Clémence',  email: 'clem62.krys@hotmail.com',       jour: 'Dimanche', date: '24/05/2026', h1: '14:30', h2: '15:00', sujet: "Comment la physique permet-elle de mesurer la puissance d'un coup de poing ?" },
  { prenom: 'Ely',       email: 'elypagoulatos@gmail.com',       jour: 'Dimanche', date: '24/05/2026', h1: '16:00', h2: '16:30', sujet: '' },
  { prenom: 'Ilya',      email: 'ilya.gabauds@gmail.com',        jour: 'Dimanche', date: '24/05/2026', h1: '16:30', h2: '17:00', sujet: '' },
  { prenom: 'Lucile',    email: 'lucilesb@icloud.com',           jour: 'Dimanche', date: '24/05/2026', h1: '17:00', h2: '17:30', sujet: '' },
  { prenom: 'Hélène',    email: 'helenembak.8@gmail.com',        jour: 'Dimanche', date: '24/05/2026', h1: '17:30', h2: '18:00', sujet: "Les performances exceptionnelles d'Usain Bolt sont-elles inscrites dans ses gènes ?" },
  { prenom: 'Nora',      email: 'Idoranenora@gmail.com',         jour: 'Dimanche', date: '24/05/2026', h1: '18:00', h2: '18:30', sujet: "Pourquoi les personnes atteintes de trisomie 21 sont-elles moins susceptibles de contracter un cancer solide ?" },
  { prenom: 'Diane',     email: 'dianeherve72@gmail.com',        jour: 'Dimanche', date: '24/05/2026', h1: '18:30', h2: '19:00', sujet: "Comment expliquer le comportement d'accompagnement à la mise bas chez certaines femelles de mammifères ?" },
  { prenom: 'Rahima',    email: 'rahimaanid0@gmail.com',         jour: 'Dimanche', date: '24/05/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { prenom: 'Noe',       email: 'Sonia.foulon@sfr.fr',           jour: 'Dimanche', date: '24/05/2026', h1: '19:30', h2: '20:00', sujet: '' },
  { prenom: 'Johanna',   email: 'johanna.ouazana@gmail.com',     jour: 'Dimanche', date: '24/05/2026', h1: '20:00', h2: '20:30', sujet: "Comment la thérapie miroir permet-elle de traiter les douleurs liées aux membres fantômes après une amputation ?" },
  { prenom: 'Meryam',    email: 'meryamlounissi012@gmail.com',   jour: 'Dimanche', date: '24/05/2026', h1: '20:30', h2: '21:00', sujet: '' },
  // Lundi 25/05/2026
  { prenom: 'Jasmine',   email: 'jasminesadi213@gmail.com',      jour: 'Lundi',    date: '25/05/2026', h1: '18:00', h2: '18:30', sujet: '' },
  { prenom: 'Yasmine',   email: 'yassaoubi@gmail.com',           jour: 'Lundi',    date: '25/05/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { prenom: 'Allegrah',  email: 'karandaallegrah8@gmail.com',    jour: 'Lundi',    date: '25/05/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { prenom: 'Eliot',     email: 'eliot.goujard@gmail.com',       jour: 'Lundi',    date: '25/05/2026', h1: '20:00', h2: '20:30', sujet: '' },
  { prenom: 'Yohai',     email: 'yohaibitton@icloud.com',        jour: 'Lundi',    date: '25/05/2026', h1: '20:30', h2: '21:00', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.prenom.padEnd(10)} ${s.email.padEnd(36)} ${s.jour} ${s.date} ${s.h1}-${s.h2}  → `)
  try {
