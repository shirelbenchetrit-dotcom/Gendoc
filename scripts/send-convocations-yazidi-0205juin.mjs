// Envoi convocations - Mme Dounia Yazidi - PC - Mar 02/06 + Jeu 04/06 + Ven 05/06/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-yazidi-0205juin.mjs
...
const students = [
  // Mardi 02/06/2026
  { nom: 'Djoubani Samia',         email: 'Sdj190208@gmail.com',         jour: 'Mardi',    date: '02/06/2026', h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Sow Abou',               email: 'sow.abous@laposte.net',       jour: 'Mardi',    date: '02/06/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Buchser Renard Eliott',  email: 'eliott.buchser@gmail.com',    jour: 'Mardi',    date: '02/06/2026', h1: '20:00', h2: '20:30', sujet: '' },
  { nom: 'Ghastine Sael',          email: 'ghastine.sael@gmail.com',     jour: 'Mardi',    date: '02/06/2026', h1: '20:30', h2: '21:00', sujet: '' },
  // Jeudi 04/06/2026
  { nom: 'Fillod Noëline',         email: 'noeline.fillod@gmail.com',    jour: 'Jeudi',    date: '04/06/2026', h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Copine Elijah',          email: 'elijah77400@gmail.com',       jour: 'Jeudi',    date: '04/06/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Célia Egue',             email: 'ainaegue95@gmail.com',        jour: 'Jeudi',    date: '04/06/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'Forget Lili-Rose',       email: 'liliroseforget@gmail.com',    jour: 'Jeudi',    date: '04/06/2026', h1: '19:30', h2: '20:00', sujet: '' },
  { nom: 'Mauriet Maëlys',         email: 'maelysmauriet@gmail.com',     jour: 'Jeudi',    date: '04/06/2026', h1: '20:00', h2: '20:30', sujet: '' },
  { nom: 'Girard Emmie',           email: 'emmie.girard0601@gmail.com',  jour: 'Jeudi',    date: '04/06/2026', h1: '20:30', h2: '21:00', sujet: '' },
  // Vendredi 05/06/2026
  { nom: 'Dmytryshak Viktoriia',   email: 'viktoriia2022dm@gmail.com',   jour: 'Vendredi', date: '05/06/2026', h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Emma Da Maia-Levy',      email: 'edml750131@gmail.com',        jour: 'Vendredi', date: '05/06/2026', h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Rakid Noor',             email: 'noor.rakid@gmail.com',        jour: 'Vendredi', date: '05/06/2026', h1: '19:00', h2: '19:30', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(24)} ${s.email.padEnd(36)} ${s.jour.padEnd(8)} ${s.date} ${s.h1}-${s.h2}  → `)
  try {
