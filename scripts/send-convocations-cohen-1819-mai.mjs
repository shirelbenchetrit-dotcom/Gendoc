// Envoi convocations - Mme Vanessa Cohen - Maths - Lun 18/05 + Mar 19/05/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-cohen-1819-mai.mjs
...
const students = [
  // Lundi 18/05/2026
  { nom: 'Gaspard du Garreau',         email: 'gasparddugarreau@gmail.com', jour: 'Lundi', date: '18/05/2026', h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Jolibert Eléa',              email: 'eleajolibert@gmail.com',     jour: 'Lundi', date: '18/05/2026', h1: '18:30', h2: '19:00', sujet: '' },
  // Mardi 19/05/2026
  { nom: 'Clémence Crochard--Cossade', email: 'clemencecrocos@outlook.fr',  jour: 'Mardi', date: '19/05/2026', h1: '18:30', h2: '19:00', sujet: "Si je peux vérifier une solution en un clin d'œil, cela signifie-t-il que je peux la résoudre à la vitesse de l'éclair ?" },
  { nom: 'Bos Juliette',               email: 'juliettebos2008@icloud.com', jour: 'Mardi', date: '19/05/2026', h1: '19:00', h2: '19:30', sujet: '' },
  { nom: 'Halifi Ethan',               email: 'halifiethan@icloud.com',     jour: 'Mardi', date: '19/05/2026', h1: '19:30', h2: '20:00', sujet: "Comment évaluer la fiabilité d'un test de dépistage médical grâce aux mathématiques ?" },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(32)} ${s.email.padEnd(36)} ${s.jour} ${s.date} ${s.h1}-${s.h2}  → `)
  try {
