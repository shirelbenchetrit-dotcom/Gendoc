// Envoi convocations - Mme Benramdane - SVT - Dimanche 07/06/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-benramdane-0706.mjs
...
const students = [
  { nom: 'Richard Tegny',    email: 'tegnyrichard@gmail.com',     h1: '10:00', h2: '10:30', sujet: '' },
  { nom: 'Clara Saadoun',    email: 'clara.saadoun@hotmail.com',  h1: '11:00', h2: '11:30', sujet: '' },
  { nom: 'Pierre Amélia',    email: 'amelia.pierre2025@gmail.com',h1: '11:30', h2: '12:00', sujet: '' },
  { nom: 'Hugo Schwartz',    email: 'hugoschwartz38@gmail.com',   h1: '12:00', h2: '12:30', sujet: '' },
  { nom: 'Nouhaud Maelys',   email: 'nouhaudmaelys@gmail.com',    h1: '12:30', h2: '13:00', sujet: '' },
  { nom: 'Shapiro Lilly',    email: 'lillyshap@icloud.com',       h1: '13:00', h2: '13:30', sujet: '' },
  { nom: 'Kadadi Rajae',     email: 'kadadirajae@gmail.com',      h1: '13:30', h2: '14:00', sujet: '' },
  { nom: 'Chasle Susie',     email: 'susiechasle@gmail.com',      h1: '14:00', h2: '14:30', sujet: '' },
  { nom: 'Aurelie Conan',    email: 'aurelie.conangr@gmail.com',  h1: '14:30', h2: '15:00', sujet: '' },
  { nom: 'Bouram Adam',      email: 'adambouram2000@gmail.com',   h1: '15:00', h2: '15:30', sujet: '' },
  { nom: 'Patrasca Roxana',  email: 'roxanapatrasca@gmail.com',   h1: '15:30', h2: '16:00', sujet: '' },
  { nom: 'Roux Lorena',      email: 'lorena.roux2008@gmail.com',  h1: '16:00', h2: '16:30', sujet: '' },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(22)} ${s.email.padEnd(36)} ${s.h1}-${s.h2}  → `)
  try {
