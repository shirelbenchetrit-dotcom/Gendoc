// Envoi convocations - Mme Vanessa Cohen - Maths - Dimanche 24/05/2026
// Template v3 (Meet) + BCC + nom complet
// Usage : node scripts/send-convocations-cohen-2405.mjs
...
const students = [
  { nom: 'Lema Djoanna',               email: 'lemadjoanna@gmail.com',           h1: '09:00', h2: '09:30', sujet: "Pourquoi le LSD ne crée pas d'addiction contrairement à la Monster ? (avec SVT)" },
  { nom: 'Bérénice Dupuy-Guérin',      email: 'berenicedupuyguerin@gmail.com',   h1: '09:30', h2: '10:00', sujet: '' },
  { nom: 'Nathan Deffo',               email: 'nathanfoka83@gmail.com',          h1: '10:00', h2: '10:30', sujet: '' },
  { nom: 'Anaelle Rath',               email: 'anaelle.rath@live.fr',            h1: '10:30', h2: '11:00', sujet: '' },
  { nom: 'Amandine Becle',             email: 'amandine.becle@gmail.com',        h1: '11:00', h2: '11:30', sujet: "Comment les mathématiques peuvent-elles modéliser la propagation d'une maladie ?" },
  { nom: 'Ness Benarroch',             email: 'nessesther.benarroch@gmail.com',  h1: '11:30', h2: '12:00', sujet: "Comment les mathématiques peuvent sauver les diabétiques ?" },
  { nom: 'Kaddour Amine',              email: 'amine.kaddour1@yahoo.com',        h1: '12:00', h2: '12:30', sujet: '' },
  { nom: 'Forestier Diane',            email: 'diane.forestiergerbert@gmail.com', h1: '12:30', h2: '13:00', sujet: '' },
  { nom: 'Manaresi Hannah',            email: 'manaresi.hannah@gmail.com',       h1: '14:00', h2: '14:30', sujet: '' },
  { nom: 'Zbair Yasmine',              email: 'yas.zbair@gmail.com',             h1: '14:30', h2: '15:00', sujet: '' },
  { nom: 'Sivapatham Abhi',            email: 'Abhisivapatham@gmail.com',        h1: '15:00', h2: '15:30', sujet: '' },
  { nom: 'Torti Eva',                  email: 'eva.torti@icloud.com',            h1: '15:30', h2: '16:00', sujet: "Comment les mathématiques permettent-elles de lever le doute entre une coïncidence banale et une activité opérationnelle ?" },
  { nom: 'Kouyate - Percherin Mina',   email: 'mina.kouyate.percherin@gmail.com', h1: '16:00', h2: '16:30', sujet: "Comment déterminer des isotopes (maths et physique) ?" },
  { nom: 'Keusseoglou Anguélos',       email: 'amkeusseoglou@gmail.com',         h1: '16:30', h2: '17:00', sujet: "Comment déterminer l'aire moyenne de l'ombre d'un cube en rotation avec nos outils mathématiques ?" },
  { nom: 'Tidji Newelsa',              email: 'newelsat@gmail.com',              h1: '17:00', h2: '17:30', sujet: '' },
  { nom: 'Rodeanu Andrei',             email: 'rodeanua8@gmail.com',             h1: '17:30', h2: '18:00', sujet: '' },
  { nom: 'DEPRAETER--NAWROTEK Aymeric', email: 'aymericdn2912@gmail.com',        h1: '18:00', h2: '18:30', sujet: '' },
  { nom: 'Ben Sassi Yasmine',          email: 'yasminebensassi06@gmail.com',     h1: '18:30', h2: '19:00', sujet: '' },
  { nom: 'Khaloufi Lilia',             email: 'khaloufililia@gmail.com',         h1: '19:00', h2: '19:30', sujet: "Dans quelle mesure les modèles mathématiques permettent-ils de prédire l'évolution d'une tumeur ?" },
]
...
for (const s of students) {
  process.stdout.write(`  • ${s.nom.padEnd(30)} ${s.email.padEnd(40)} ${s.h1}-${s.h2}  → `)
  try {
